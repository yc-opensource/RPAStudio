...
namespace RPAStudio.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        {
            //检查更新
            ViewModelLocator.Instance.Help.CheckUpgradeCommand.Execute(null);
        ...
        private readonly string prefixTitle = "MoRPA Studio";
        ...
        public RelayCommand RecordingCommand => _recordingCommand ?? (_recordingCommand = new RelayCommand(() =>
        {
            ...
            MessageBox.Show(Application.Current.MainWindow, "请新建或打开一个已有文档来保存录制的结果", "提示", MessageBoxButton.OK, MessageBoxImage.Asterisk);
        }));
